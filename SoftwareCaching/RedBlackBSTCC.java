...
public class RedBlackBSTCC<Key extends Comparable<Key>, Value> {

    private static final boolean RED   = true;
    private static final boolean BLACK = false;

    private Node root;     // root of the BST
    private Node cache; // Previous accessed node
    private Key cache_key;
    private Value cache_val;
    ...
    public Value get(Key key) {
        ...
        if (key.equals (cache_key)) return cache_val;
        return get (root, key);
    }
